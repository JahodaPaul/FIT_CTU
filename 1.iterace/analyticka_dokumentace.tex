...
\usepackage[marginparsep=8pt,left=2.5cm,right=2.5cm,top=3cm,bottom=4cm]{geometry}
...
\begin{figure}
\begin{center}
  \includegraphics[width=0.7\textwidth]{\picturesfolder/State_diagram_ukol}
...
\begin{figure}
\begin{center}
  \includegraphics[width=0.7\textwidth]{\picturesfolder/State_diagram_vybaveni}
