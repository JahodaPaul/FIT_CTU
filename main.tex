...
\begin{figure}[]
    \centering
    \subfloat[First proposed path]{{\includegraphics[width=0.3\textwidth]{images/dia1.pdf} }}%
    \quad
    \subfloat[Second proposed path]{{\includegraphics[width=0.3\textwidth]{images/dia2.pdf} }}%
    \quad
    \subfloat[Third proposed path]{{\includegraphics[width=0.3\textwidth]{images/dia3.pdf} }}%
...
\begin{figure}[]
    \centering
    \subfloat[Distance between the two cars]{{\includegraphics[width=0.46\textwidth]{images/distances.pdf} }}%
    \quad
    \subfloat[Car speed of the two cars]{{\includegraphics[width=0.46\textwidth]{images/speeds.pdf} }}%
    \quad
    \subfloat[Angle between the two cars]{{\includegraphics[width=0.46\textwidth]{images/angles.pdf} }}%
    \quad
    \subfloat[Yaw rate of the two cars]{{\includegraphics[width=0.46\textwidth]{images/yaw_rate.pdf} }}%
...
\begin{figure}[h]
    \centering
    \subfloat[Class distribution]{{\includegraphics[width=0.46\textwidth]{images/bar_chart_drivable.pdf} }}%
    \quad
